...
?>
<div class="swpm-login-widget-form section no-border">
    <form id="swpm-login-form" name="swpm-login-form" method="post" action="">
        <div class="swpm-login-form-inner">
            ...
            <div class="swpm-login-submit">
                <input type="submit" class="swpm-login-form-submit button" name="swpm-login" value="<?php echo SwpmUtils::_('Login') ?>"/>
            </div>
